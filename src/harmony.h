...
public: 
  ...
  int cluster_cpp();
  void init_celltype_cpp(VECTYPE __Pr_celltype);
  ...
  // buffers
  MATTYPE _scale_dist, dist_mat, O, E, O2, E2, dir_prior, Phi_Rk; // N_k, N_kb, N_b, numerator, denominator, C;
  uvec update_order, cells_update;
  MATTYPE W;
  
  // flags
  bool ran_setup, ran_init, verbose, do_celltype; // do_merge_R;
